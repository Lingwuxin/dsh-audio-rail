...
![Demo: the turn-rail anchors pulsing with the music](docs/demo1.gif)

GitHub strips hand-written `<video>` tags, so the demo ships as an auto-looping inline GIF; the full video with audio is at [demo1.mp4](docs/demo1.mp4).
...
| `docs/demo1.gif` | Demo animation (inline in the README) |
| `docs/demo1.mp4` | Full demo video |
